...
const translations = {
  ru: {
    ...
    hero: {
      ...
      title1: "Будильник, ",
      title2: "который будит селфи",
      description: "Звонит в заданное время и выключается снимком. Каждое утро — кадр, через месяц — таймлапс прогресса фейс-йоги.",
  ...
  en: {
    ...
    hero: {
      ...
      title1: "The alarm clock ",
      title2: "you turn off with a selfie",
      description: "It rings at the time you set and stops when you take the shot. One frame each morning; a month later, a timelapse of your face yoga progress.",
  ...
  tr: {
    ...
    hero: {
      ...
      title1: "Selfie ile ",
      title2: "kapattığınız alarm",
      description: "Kurduğunuz saatte çalar ve fotoğrafı çekince susar. Her sabah bir kare; bir ay sonra yüz yogası ilerlemenizin zaman atlamalı videosu.",
