  ...
  ru: {
    ...
    sections: {
      ...
      analytics: {
        ...
        list: [
          "Уходит: название события, версия приложения, платформа, случайный идентификатор установки и два числа о серии — сколько в ней фотографий и сколько дней прошло с самой старой",
          ...
          "Не уходит: сами фотографии, данные о лице, даты съёмки, содержимое галереи, местоположение, контакты",
  ...
  en: {
    ...
    sections: {
      ...
      analytics: {
        ...
        list: [
          "Sent: the event name, the app version, the platform, a random install identifier, and two numbers about your series — how many photos it holds and how many days since its oldest",
          ...
          "Not sent: the photos themselves, face data, capture dates, gallery contents, location, contacts",
  ...
  tr: {
    ...
    sections: {
      ...
      analytics: {
        ...
        list: [
          "Gönderilir: olayın adı, uygulama sürümü, platform, rastgele bir kurulum kimliği ve seriniz hakkında iki sayı — kaç fotoğraf içerdiği ve en eskisinden bu yana kaç gün geçtiği",
          ...
          "Gönderilmez: fotoğrafların kendisi, yüz verisi, çekim tarihleri, galeri içeriği, konum, kişiler",
